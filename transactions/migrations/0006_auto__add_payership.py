...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'transactions_payership', (
            ...
            ('weight', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=100)),
    ...
    models = {
        ...
        u'transactions.payership': {
            ...
            'weight': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '100'})
        },
