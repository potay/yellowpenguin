...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Paymentship.transaction'
        db.delete_column(u'transactions_paymentship', 'transaction_id')


    def backwards(self, orm):
        # Adding field 'Paymentship.transaction'
        db.add_column(u'transactions_paymentship', 'transaction',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['transactions.Transaction']),
                      keep_default=False)
