...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.to_user'
        db.add_column(u'transactions_transaction', 'to_user',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Transaction.other_party'
        db.add_column(u'transactions_transaction', 'other_party',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='trans_other_party', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.to_user'
        db.delete_column(u'transactions_transaction', 'to_user')

        # Deleting field 'Transaction.other_party'
        db.delete_column(u'transactions_transaction', 'other_party_id')
