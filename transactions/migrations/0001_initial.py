...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'transactions_transaction', (
            ...
            ('title', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('inflow', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('outflow', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
