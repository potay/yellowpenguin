...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Paymentship.agreement'
        db.add_column(u'transactions_paymentship', 'agreement',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['transactions.FinancialAgreement']),
                      keep_default=False)


        # Changing field 'Paymentship.transaction'
        db.alter_column(u'transactions_paymentship', 'transaction_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['transactions.Transaction']))

    def backwards(self, orm):
        # Deleting field 'Paymentship.agreement'
        db.delete_column(u'transactions_paymentship', 'agreement_id')


        # Changing field 'Paymentship.transaction'
        db.alter_column(u'transactions_paymentship', 'transaction_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['transactions.FinancialAgreement']))
